...
def getActions(wsdl):
    ...
    bs = BeautifulSoup(wsdl)
    
    actions = bs.findAll('soap:operation')
    ...
    for action in actions:
        ...
        returnDict[action_name] = action_location
        
    return returnDict
        
print getActions(wsdl)['GetCityForecastByZIP']


#print operations[9].prettify()

# for operation in operations:
#     if len(operation.findAll("http:operation")) > 0:
#         print operation.prettify()
    #print operation.prettify()
